...
def hub_tests():
    ...
    s.expect(PacketOutputEvent("eth0", stp_pkt, "eth1", stp_pkt, "eth2", stp_pkt, "eth3", stp_pkt), "Expecting STP packets")
    ...
    s.expect(PacketOutputEvent("eth1", stp_pkt, "eth2", stp_pkt, "eth3", stp_pkt), "Expecting STP packets to be broadcasted")
